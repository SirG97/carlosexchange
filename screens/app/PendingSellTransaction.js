...
const PendingSellTransaction = ({ route, navigation }) => {
    const { transaction, coin } = route.params.data
    console.log('tansaction is ',transaction, 'The route param is ', route.params)
    ...
    const startUpload = async() => {
      ...
      console.log('form data is ', formData)
       const url = 'https://app.carlosexchange.com/api/user/sell/order/complete';
     ...
     //    //    console.log(`The message is ${message}, \nStatus is  ${status}, \n User ID is ${data.user_id}`);
            if(status !== 'success'){
                ...
                return showModal('error', 'Error', message, 'OK')
            }else{
                    ...
                    <View style={styles.authFormContainer} itemStyle={styles.input}>
                        ...
                        <View style={styles.txnInfoContainer}>
                            <Paragraph style={styles.txnInfoMsg}>
                                Kindly pay the above amount to the payment wallet provided below. You will recieve the naira equivalence of the amount in the bank account provided during registration. Please use another crypto wallet other than Paxful to avoid amount reduction. Thanks.
                            </Paragraph>
                            ...
                            <View style={styles.txnList}>
                                ...
                                <View style={styles.txnContent}>
                                    ...
                                    <View style={styles.txnVal}>
                                        <View>
                                            <Text style={styles.txnValText}>{coin ? coin.address: ''} </Text>
                                            <Ionicons name="copy" 
                                                onPress={() =>{
                                                    copyToClipboard(coin ? coin.address: '')
                                                }}
...
export default PendingSellTransaction;